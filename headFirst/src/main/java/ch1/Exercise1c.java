/*
 * This file contains the source code for the "Exercise1c" Java program.
 * It demonstrates a 'while' loop combined with an 'if' condition,
 * showing how the loop's counter and conditional logic interact.
 * This code is identical in functionality to Exercise1b.
 */
...
/*
 * Summary of Concepts:
 * This program, identical in behavior to `Exercise1b`, effectively demonstrates:
 * 1.  **Variables**: Declaring and initializing an **integer variable** (`int x`).
 * 2.  **Output**: Printing messages to the console using `System.out.println()`.
